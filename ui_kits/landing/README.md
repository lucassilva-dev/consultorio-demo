# Landing Page UI Kit — Marina Alves

A pixel-faithful recreation of the personal-brand landing page described in the design brief, built with React (inline JSX + Babel) on top of `colors_and_type.css`.
...
- `Fechamento.jsx` — emotional closing CTA.
- `Footer.jsx` — name, CRP, social, disclaimer.

All components are static (no API). Buttons link to `#`. The portrait is `assets/portrait-placeholder.svg`.
